...
class RealtimeListener : public ExitGames::LoadBalancing::Listener
{
public:
	RealtimeListener(UIListener* pOutputListener, const ExitGames::Common::JString& playerName);

	void service(void);
	void connect(void);
	void disconnect(void);
	void toggleSendData(void);
